    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="flex items-center justify-between max-w-6xl mx-auto px-6 py-5">
        ...
        <div className="flex items-center gap-6">
          <a href="https://github.com/anthonye4259/alaii-engage" className="text-sm text-text-secondary hover:text-text-primary transition flex items-center gap-1.5" target="_blank" rel="noopener">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-24 text-center">
        <div className="inline-flex items-center gap-2 bg-accent/5 border border-accent/20 rounded-full px-4 py-1.5 mb-6">
          ...
          <span className="text-xs font-medium text-accent">Now open source — self-host or use our managed API</span>
        </div>
    ...
    "context": { "originalContent": "love your work!" }
      ...
      <footer className="border-t border-border py-8">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="https://github.com/anthonye4259/alaii-engage" className="text-xs text-text-muted hover:text-text-secondary" target="_blank" rel="noopener">GitHub</a>
